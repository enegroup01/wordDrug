...
class PageViewController: UIViewController,UIScrollViewDelegate{
    ...
    ["al10","an10","ar10","ea10","ee10","el10","en10","er10","i_e10","say10"],
    ...
    override func viewDidLoad() {
        ...
        //self.view.bringSubview(toFront: pageController)
        //self.view.bringSubview(toFront: scrollViewController)
    ...
    @objc func toNewGame(_ notification: NSNotification){
        ...
        if let syllableReceived = notification.userInfo?["syllable"] as? String {
            ...
            for i in  0 ..< syllableSets[currentPage].count{
                ...
                if let syllableWithoutDigit = (syllableSets[currentPage][i].components(separatedBy: NSCharacterSet.decimalDigits) as NSArray).componentsJoined(by: "") as String?{
                    

                    if syllableReceived == syllableWithoutDigit{
    ...
    func findPageSyllables(page:Int){
        ...
        ball0 = Node(text: pageSyllables[0], image: UIImage(), color: darkBlueColor, radius: 35, name: pageSyllables[0])
        ball1 = Node(text: pageSyllables[1], image: UIImage(), color: darkBlueColor, radius: 35, name: pageSyllables[1])
        ball2 = Node(text: pageSyllables[2], image: UIImage(), color: darkBlueColor, radius: 35, name: pageSyllables[2])
        ball3 = Node(text: pageSyllables[3], image: UIImage(), color: darkBlueColor, radius: 35, name: pageSyllables[3])
        ball4 = Node(text: pageSyllables[4], image: UIImage(), color: darkBlueColor, radius: 35, name: pageSyllables[4])
        ball5 = Node(text: pageSyllables[5], image: UIImage(), color: darkBlueColor, radius: 35, name: pageSyllables[5])
        ball6 = Node(text: pageSyllables[6], image: UIImage(), color: darkBlueColor, radius: 35, name: pageSyllables[6])
        ball7 = Node(text: pageSyllables[7], image: UIImage(), color: darkBlueColor, radius: 35, name: pageSyllables[7])
        ball8 = Node(text: pageSyllables[8], image: UIImage(), color: darkBlueColor, radius: 35, name: pageSyllables[8])
        ball9 = Node(text: pageSyllables[9], image: UIImage(), color: darkBlueColor, radius: 35, name: pageSyllables[9])
